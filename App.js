...
export default function App() {
  ...
  return (
    <View
      ...
      <Text>Dados da sua notificação: {expoPushToken}</Text>
...
async function registerForPushNotificationsAsync() {
  ...
  if (Device.isDevice) {
    ...
    if (finalStatus !== 'granted') {
      alert('Falhou para exibir a notificação');
      return;
    }
    try{
    ...
    alert('Precisa ser um dispositivo físico');
  }
